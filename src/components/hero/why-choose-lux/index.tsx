...
const WhyChooseLux = () => {
  ...
  return (
    <section id="why-choose-lux" className="mt-[48px] lg:mt-16 px-[20px] custom-md:px-0 pb-[32px] custom-md:pb-[48px] lg:pb-16 bg-white custom-md:max-w-[746px] lg:max-w-[960px] mx-auto ">
      <div className="">
