...
const WhatIsLux = () => {
    ...
    return (
        <section id="what-is-lux" className="w-full bg-[#F4F3FB] custom-md:max-h-[814px] px-[20px] lg:px-0 custom-md:px-[32px] lg:py-0 py-[32px] custom-md:py-[48px] mt-[32px] custom-md:mt-[48px] lg:mt-[64px]">
