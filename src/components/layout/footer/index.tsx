      ...
      <div className=" max-w-[350px] custom-md:max-w-[960px] mx-auto ">
        ...
        <div className="hidden custom-md:flex justify-between mb-[60px] custom-md:mt-[64px] font-body ">
          <div className="flex flex-col custom-md:gap-[32px] lg:gap-[24px] [letter-spacing:-0.01em] [word-spacing:-0.1.5px]">
            <a href="https://lux-web-theta.vercel.app/login" className="text-white text-[16px] leading-[20.8px] font-[500] flex items-center gap-[10px] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.bookNow')} <img src="/assets/SmallArrow.svg" alt="" className='rotate-90 w-[14.5px] h-[15px]' />
            </a>
            <a href="/#what-is-lux" onClick={(e) => handleScrollToSection(e, 'what-is-lux')} className="text-white text-[16px] leading-[20.8px] [letter-spacing:-0.01em] [word-spacing:-2px] font-[500] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.whatIsLux')}<span className='[word-spacing:-0px]' style={locale === 'es' ? { wordSpacing: '0px' } : {}}>&nbsp;{t('footer.ourServices')}</span>
            </a>
            <a href="/#why-choose-lux" onClick={(e) => handleScrollToSection(e, 'why-choose-lux')} className="text-white text-[16px] leading-[21px] font-[500] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.whyChooseLux')}
            </a>
            <a href="/#start-earning" onClick={(e) => handleScrollToSection(e, 'start-earning')} className="text-white text-[16px] leading-[21px] font-[500] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
          ...
          <div className="flex flex-col gap-y-[24px]">
            <Link href="/" className="text-white leading-[20.8px] [letter-spacing:-0.01em] text-base font-medium hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              <span className="[word-spacing:-2px]">{t('footer.chatWith')}</span> {t('footer.us')}
            </Link>
            <Link href="/" className="text-white leading-[20.8px] [word-spacing:-2px] [letter-spacing:-0.01em] text-base font-medium hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.faqs')}
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col custom-md:hidden gap-[32px] mt-[64px] mb-[61px] max-w-[350px]">
          ...
          <div className="flex flex-col gap-[32px] font-body [letter-spacing:-0.01em] [word-spacing:-0.1.5px]">
            <a href="https://lux-web-theta.vercel.app/login" className="text-white text-[16px] font-[500] flex items-center gap-[11px] hover:opacity-80 leading-[20.8px] transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.bookNow')} <img src="/assets/SmallArrow.svg" alt="" className='rotate-90 w-[14.5px] h-[15px]' />
            </a>
            <a href="/#what-is-lux" onClick={(e) => handleScrollToSection(e, 'what-is-lux')} className="text-white text-[16px] leading-[20.8px] [letter-spacing:-0.01em] [word-spacing:-2px] font-[500] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.whatIsLux')}<span className='[word-spacing:-0px]' style={locale === 'es' ? { wordSpacing: '0px' } : {}}>&nbsp;{t('footer.ourServices')}</span>
            </a>
            <Link href="/#why-choose-lux" onClick={(e) => handleScrollToSection(e, 'why-choose-lux')} className="text-white text-[16px] font-[500] hover:opacity-80 leading-[20.8px] transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.whyChooseLux')}
            </Link>
            <Link href="/#start-earning" onClick={(e) => handleScrollToSection(e, 'start-earning')} className="text-white text-[16px] font-[500] hover:opacity-80 leading-[20.8px] transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.startEarning')}
            </Link>
          </div>
          ...
          <div className="flex flex-col gap-[24px] mt-[32px] font-body">
            <Link href="/" className="text-white [letter-spacing:-0.01em]  text-[16px] leading-[20.8px] font-[500] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              <span className="[word-spacing:-2px]">{t('footer.chatWith')}</span> {t('footer.us')}
            </Link>
            <Link href="/" className="text-white [letter-spacing:-0.01em]  text-[16px] leading-[20.8px] font-[500] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.faqs')}
          ...
          <div className="flex flex-col gap-[24px] mt-[32px] [letter-spacing:-0.01em] font-body">
            <a href="https://lux-web-theta.vercel.app/privacy-policy" className="text-white text-[16px] leading-[20.8px] font-[500] hover:opacity-80 transition-opacity">
              {t('footer.privacyMobile')}
            </a>
            <a href="https://lux-web-theta.vercel.app/terms-of-service" className="text-white text-[16px] leading-[20.8px] font-[500] hover:opacity-80 transition-opacity">
        ...
        <div className="flex flex-col sm:flex-row font-body items-start sm:items-center justify-between ">
          ...
          <div className="hidden custom-md:flex items-center gap-x-[32px] ">
            <a href="https://lux-web-theta.vercel.app/privacy-policy" className="text-white text-[16px] font-[500] [word-spacing:-1px] [letter-spacing:-0.01em] mt-[3px] leading-[20.8px] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.privacy')}
            </a>
            <a href="https://lux-web-theta.vercel.app/terms-of-service" className="text-white text-[16px] font-[500] [word-spacing:-1px] [letter-spacing:-0.01em] mt-[3px] leading-[20.8px] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.terms')}
            </a>
            <a href="https://lux-web-theta.vercel.app/privacy-policy" className="text-white text-[16px] font-[500] [word-spacing:-1px] [letter-spacing:-0.01em] mt-[3px] leading-[20.8px] hover:opacity-80 transition-opacity" style={locale === 'es' ? { wordSpacing: '0px' } : {}}>
              {t('footer.safety')}
